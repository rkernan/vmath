...
BOOST_AUTO_TEST_SUITE(matrix3x2)

BOOST_AUTO_TEST_CASE_TEMPLATE(size, T, float_types) {
	BOOST_CHECK(sizeof(math::core::matrix<T, 3, 2>) == 2 * 3 * sizeof(T));
}

BOOST_AUTO_TEST_CASE_TEMPLATE(create, T, float_types) {
	// default constructor
	math::core::matrix<T, 3, 2> M_default;
	...
	std::array<math::core::vector<T, 3>, 2> data = {{
	...
	math::core::matrix<T, 3, 2> M_param(data);
	...
	math::core::matrix<T, 3, 2> M_param2(col1, col2);
...
BOOST_AUTO_TEST_CASE_TEMPLATE(copy, T, float_types) {
	...
	math::core::matrix<T, 3, 2> M_copy(M);
...
BOOST_AUTO_TEST_CASE_TEMPLATE(move, T, float_types) {
	...
	M[1][1] = static_cast<T>(5.0);
	M[1][2] = static_cast<T>(6.0);
	math::core::matrix<T, 3, 2> M_move(std::move(M));
...
BOOST_AUTO_TEST_CASE_TEMPLATE(members, T, float_types) {
	...
	BOOST_CHECK_THROW((M[2] = math::core::vector<T, 3>()), std::out_of_range);
}
...
BOOST_AUTO_TEST_CASE_TEMPLATE(assign, T, float_types) {
	...
	M[1][1] = static_cast<T>(5.0);
	M[1][2] = static_cast<T>(6.0);
	math::core::matrix<T, 3, 2> M_assign;
	M_assign = M;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(matrix_add_eq, T, float_types) {
	...
	M2[1][1] = static_cast<T>(2.0);
	M2[1][2] = static_cast<T>(1.0);
	math::core::matrix<T, 3, 2> M_add = M1;
	M_add += M2;
	BOOST_CHECK_CLOSE(M_add[0][0], static_cast<T>(7.0), 1e-4f);
	BOOST_CHECK_CLOSE(M_add[0][1], static_cast<T>(7.0), 1e-4f);
	BOOST_CHECK_CLOSE(M_add[0][2], static_cast<T>(7.0), 1e-4f);
...
BOOST_AUTO_TEST_CASE_TEMPLATE(matrix_sub_eq, T, float_types) {
	...
	M2[1][1] = static_cast<T>(2.0);
	M2[1][2] = static_cast<T>(1.0);
	math::core::matrix<T, 3, 2> M_sub = M1;
	M_sub -= M2;
	BOOST_CHECK_CLOSE(M_sub[0][0], static_cast<T>(-5.0), 1e-4f);
	BOOST_CHECK_CLOSE(M_sub[0][1], static_cast<T>(-3.0), 1e-4f);
	BOOST_CHECK_CLOSE(M_sub[0][2], static_cast<T>(-1.0), 1e-4f);
...
BOOST_AUTO_TEST_CASE_TEMPLATE(matrix_mult, T, float_types) {
	...
	M_sum3x2 = M * M_2x2;
	BOOST_CHECK_CLOSE(M_sum3x2[0][0], static_cast<T>(9.0), 1e-4f);
	BOOST_CHECK_CLOSE(M_sum3x2[0][1], static_cast<T>(12.0), 1e-4f);
	BOOST_CHECK_CLOSE(M_sum3x2[0][2], static_cast<T>(15.0), 1e-4f);
	BOOST_CHECK_CLOSE(M_sum3x2[1][0], static_cast<T>(19.0), 1e-4f);
	BOOST_CHECK_CLOSE(M_sum3x2[1][1], static_cast<T>(26.0), 1e-4f);
	BOOST_CHECK_CLOSE(M_sum3x2[1][2], static_cast<T>(33.0), 1e-4f);
	math::core::matrix<T, 3> M_sum3x3;
	M_sum3x3 = M * M_2x3;
	BOOST_CHECK_CLOSE(M_sum3x3[0][0], static_cast<T>(9.0), 1e-4f);
	BOOST_CHECK_CLOSE(M_sum3x3[0][1], static_cast<T>(12.0), 1e-4f);
	BOOST_CHECK_CLOSE(M_sum3x3[0][2], static_cast<T>(15.0), 1e-4f);
	BOOST_CHECK_CLOSE(M_sum3x3[1][0], static_cast<T>(19.0), 1e-4f);
	BOOST_CHECK_CLOSE(M_sum3x3[1][1], static_cast<T>(26.0), 1e-4f);
	BOOST_CHECK_CLOSE(M_sum3x3[1][2], static_cast<T>(33.0), 1e-4f);
	BOOST_CHECK_CLOSE(M_sum3x3[2][0], static_cast<T>(29.0), 1e-4f);
	BOOST_CHECK_CLOSE(M_sum3x3[2][1], static_cast<T>(40.0), 1e-4f);
	BOOST_CHECK_CLOSE(M_sum3x3[2][2], static_cast<T>(51.0), 1e-4f);
	math::core::matrix<T, 3, 4> M_sum3x4;
	M_sum3x4 = M * M_2x4;
	BOOST_CHECK_CLOSE(M_sum3x4[0][0], static_cast<T>(9.0), 1e-4f);
	BOOST_CHECK_CLOSE(M_sum3x4[0][1], static_cast<T>(12.0), 1e-4f);
	BOOST_CHECK_CLOSE(M_sum3x4[0][2], static_cast<T>(15.0), 1e-4f);
	BOOST_CHECK_CLOSE(M_sum3x4[1][0], static_cast<T>(19.0), 1e-4f);
	BOOST_CHECK_CLOSE(M_sum3x4[1][1], static_cast<T>(26.0), 1e-4f);
	BOOST_CHECK_CLOSE(M_sum3x4[1][2], static_cast<T>(33.0), 1e-4f);
	BOOST_CHECK_CLOSE(M_sum3x4[2][0], static_cast<T>(29.0), 1e-4f);
	BOOST_CHECK_CLOSE(M_sum3x4[2][1], static_cast<T>(40.0), 1e-4f);
	BOOST_CHECK_CLOSE(M_sum3x4[2][2], static_cast<T>(51.0), 1e-4f);
	BOOST_CHECK_CLOSE(M_sum3x4[3][0], static_cast<T>(39.0), 1e-4f);
	BOOST_CHECK_CLOSE(M_sum3x4[3][1], static_cast<T>(54.0), 1e-4f);
	BOOST_CHECK_CLOSE(M_sum3x4[3][2], static_cast<T>(69.0), 1e-4f);
}
...
BOOST_AUTO_TEST_CASE_TEMPLATE(scalar_mult_eq, T, float_types) {
	...
	M[1][2] = static_cast<T>(6.0);
	T s = static_cast<T>(2.0);
	math::core::matrix<T, 3, 2> M_mult = M;
	M_mult *= s;
	BOOST_CHECK_CLOSE(M_mult[0][0], static_cast<T>(2.0), 1e-4f);
	BOOST_CHECK_CLOSE(M_mult[0][1], static_cast<T>(4.0), 1e-4f);
	BOOST_CHECK_CLOSE(M_mult[0][2], static_cast<T>(6.0), 1e-4f);
...
BOOST_AUTO_TEST_CASE_TEMPLATE(scalar_div_eq, T, float_types) {
	...
	M[1][2] = static_cast<T>(12.0);
	T s = static_cast<T>(2.0);
	math::core::matrix<T, 3, 2> M_div = M;
	M_div /= s;
	BOOST_CHECK_CLOSE(M_div[0][0], static_cast<T>(1.0), 1e-4f);
	BOOST_CHECK_CLOSE(M_div[0][1], static_cast<T>(2.0), 1e-4f);
	BOOST_CHECK_CLOSE(M_div[0][2], static_cast<T>(3.0), 1e-4f);
...
BOOST_AUTO_TEST_CASE_TEMPLATE(transpose, T, float_types) {
	...
	M[1][1] = static_cast<T>(5.0);
	M[1][2] = static_cast<T>(6.0);
	math::core::matrix<T, 2, 3> M_trans;
	M_trans = M.transpose();
...
BOOST_AUTO_TEST_CASE_TEMPLATE(equals, T, float_types) {
	...
	math::core::matrix<T, 3, 2> M3;
	M3[0][0] = static_cast<T>(6.0);
	M3[0][1] = static_cast<T>(5.0);
	M3[0][2] = static_cast<T>(4.0);
	M3[1][0] = static_cast<T>(3.0);
	M3[1][1] = static_cast<T>(2.0);
	M3[1][2] = static_cast<T>(1.0);
	BOOST_CHECK(M1 == M2);
	BOOST_CHECK(M1 != M3);
	BOOST_CHECK(M2 != M3);
}

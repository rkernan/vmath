...
BOOST_AUTO_TEST_CASE(size) {
	BOOST_WARN(sizeof(math::Matrix4x3) != 3 * 4 * sizeof(float));
}

BOOST_AUTO_TEST_CASE(create) {
	// default constructor
	math::Matrix4x3 M_default;
	...
	math::Matrix4x3 M_param2(col1, col2, col3);
...
BOOST_AUTO_TEST_CASE(move) {
	...
	M[2][2] = 11.0f;
	M[2][3] = 12.0f;
	math::Matrix4x3 M_move(std::move(M));
...
BOOST_AUTO_TEST_CASE(members) {
	...
	BOOST_CHECK_THROW(M[3] = math::Vector4(), std::out_of_range);
}
...
BOOST_AUTO_TEST_CASE(matrix_sub) {
	...
	M2[2][2] = 2.0f;
	M2[2][3] = 1.0f;
	math::Matrix4x3 M_sub;
	M_sub = M1 - M2;
	BOOST_CHECK_CLOSE(M_sub[0][0], -11.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sub[0][1], -9.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sub[0][2], -7.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sub[0][3], -5.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sub[1][0], -3.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sub[1][1], -1.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sub[1][2], 1.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sub[1][3], 3.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sub[2][0], 5.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sub[2][1], 7.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sub[2][2], 9.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sub[2][3], 11.0f, 1e-4f);
}
...
BOOST_AUTO_TEST_CASE(matrix_mult) {
	...
	M_sum4x2 = M * M_3x2;
	BOOST_CHECK_CLOSE(M_sum4x2[0][0], 38.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sum4x2[0][1], 44.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sum4x2[0][2], 50.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sum4x2[0][3], 56.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sum4x2[1][0], 83.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sum4x2[1][1], 98.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sum4x2[1][2], 113.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sum4x2[1][3], 128.0f, 1e-4f);
	math::Matrix4x3 M_sum4x3;
	M_sum4x3 = M * M_3x3;
	BOOST_CHECK_CLOSE(M_sum4x3[0][0], 38.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sum4x3[0][1], 44.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sum4x3[0][2], 50.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sum4x3[0][3], 56.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sum4x3[1][0], 83.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sum4x3[1][1], 98.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sum4x3[1][2], 113.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sum4x3[1][3], 128.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sum4x3[2][0], 128.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sum4x3[2][1], 152.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sum4x3[2][2], 176.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sum4x3[2][3], 200.0f, 1e-4f);
	math::Matrix4x4 M_sum4x4;
	M_sum4x4 = M * M_3x4;
	BOOST_CHECK_CLOSE(M_sum4x4[0][0], 38.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sum4x4[0][1], 44.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sum4x4[0][2], 50.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sum4x4[0][3], 56.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sum4x4[1][0], 83.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sum4x4[1][1], 98.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sum4x4[1][2], 113.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sum4x4[1][3], 128.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sum4x4[2][0], 128.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sum4x4[2][1], 152.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sum4x4[2][2], 176.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sum4x4[2][3], 200.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sum4x4[3][0], 173.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sum4x4[3][1], 206.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sum4x4[3][2], 239.0f, 1e-4f);
	BOOST_CHECK_CLOSE(M_sum4x4[3][3], 272.0f, 1e-4f);
}

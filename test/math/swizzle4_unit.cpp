...
BOOST_AUTO_TEST_CASE(negate) {
	math::core::vector<float, 4> V;
	V.x = 20.12f;
	V.y = 100.89f;
	V.z = -18.2f;
	V.w = 35.62f;
	math::core::vector<float, 4> V_neg;
	V_neg = -V.yzxx;
...
BOOST_AUTO_TEST_CASE(add) {
	math::core::vector<float, 4> V1;
	V1.x = 20.12f;
	V1.y = 100.89f;
	V1.z = -18.2f;
	V1.w = 35.62f;
	math::core::vector<float, 4> V2;
	V2.x = 10.34f;
	V2.y = -15.5f;
	V2.z = 20.2f;
	V2.w = -200.34f;
	math::core::vector<float, 4> V_add;
...
BOOST_AUTO_TEST_CASE(add_eq) {
	...
	V2.z = 20.2f;
	V2.w = -200.34f;
	math::core::vector<float, 4> V_add = V1;
	V_add.yxzw += V2.xxxx;
...
BOOST_AUTO_TEST_CASE(sub) {
	...
	V2.z = 20.12f;
	V2.w = -200.34f;
	math::core::vector<float, 4> V_sub;
...
BOOST_AUTO_TEST_CASE(sub_eq) {
	...
	V2.z = 20.2f;
	V2.w = -200.34f;
	math::core::vector<float, 4> V_sub = V1;
	V_sub.yxwz -= V2.xxxx;
...
BOOST_AUTO_TEST_CASE(mult) {
	...
	V2.z = 20.2f;
	V2.w = -200.34f;
	math::core::vector<float, 4> V_mult;
...
BOOST_AUTO_TEST_CASE(mult_eq) {
	...
	V2.z = 20.2f;
	V2.w = -200.34f;
	math::core::vector<float, 4> V_mult = V1;
	V_mult.yxzw *= V2.xyxx;
...
BOOST_AUTO_TEST_CASE(div) {
	...
	V2.z = 6.0f;
	V2.z = 8.0f;
	math::core::vector<float, 4> V_div;
...
BOOST_AUTO_TEST_CASE(div_eq) {
	...
	V2.z = 6.0f;
	V2.w = 8.0f;
	math::core::vector<float, 4> V_div = V1;
	V_div.yxzw /= V2.yxxx;
...
BOOST_AUTO_TEST_CASE(scalar_mult_eq) {
	...
	V.w = 35.62f;
	float s = -34.45f;
	math::core::vector<float, 4> V_mult = V;
	V_mult.xyzw *= s;
	BOOST_CHECK_CLOSE(V_mult.x, -693.134f, 1e-4f);
	BOOST_CHECK_CLOSE(V_mult.y, -3475.6605f, 1e-4f);
	BOOST_CHECK_CLOSE(V_mult.z, 626.99f, 1e-4f);
...
BOOST_AUTO_TEST_CASE(scalar_div_eq) {
	...
	V.w = 35.62f;
	float s = -34.45f;
	math::core::vector<float, 4> V_div = V;
	V_div.xyzw /= s;
	BOOST_CHECK_CLOSE(V_div.x, -0.5840348330914369f, 1e-4f);
	BOOST_CHECK_CLOSE(V_div.y, -2.9285921625544264f, 1e-4f);
	BOOST_CHECK_CLOSE(V_div.z, 0.5283018867924527f, 1e-4f);
